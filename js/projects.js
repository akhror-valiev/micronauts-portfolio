...
// const open = document.querySelector('.project-items');

// open.addEventListener('click', ()=>{
//     console.log("click");
// })

let previewContainer = document.querySelector('.preview-section')
let previewBox = previewContainer.querySelector('.preview-container')


document.querySelectorAll('.project-section .project-items').forEach(project =>{
    project.onclick=()=>{
